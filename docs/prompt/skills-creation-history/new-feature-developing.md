...
- **검증 힌트:** PO, UX, Planning, Implementation 단계의 결과물들을 참고하여 검증합니다.
...
### (6) Documentation
- **에이전트:** `@product-owner-subagent` 호출
- **동작:** 모든 히스토리 문서(PO, UX, Planning, Implementation, QA, Unresolved Issues)를 종합하여 `docs/features/{feature명}/00.feature-overview.md`를 작성합니다.
